var color_palettes = [
    ["#2A2630", "#D3D3D3", "#605DEF", "#FFFFFF", "#5498B1"],
    ...
    ["#3E4C58", "#D3D6D9", "#080811", "#898176", "#BB6C1D"],
    ...
    ['#00FCF6', '#00C8E9', '#3492C7', '#595E93', '#552E56', '#FFFFFF', '#E5C388'],
    ['#C42EEB', '#FF8E80', '#EEE3C9', '#48064B', '#6E001A', '#5C3A00', '#005D10'],
...
menu_alt_foreground_color = menu_palette[2];
menu_contrast_color = menu_palette[4];
menu_alt_contrast_color = menu_palette[3];